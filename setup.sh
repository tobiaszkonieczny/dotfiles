...
ITEMS=(
    ...
    "quickshell-git|Wayland shell toolkit — required by Noctalia|true"
    "noctalia-shell|Desktop shell — bar, launcher, notifications, lock screen, wallpaper, theming|true"
    ...
    "network-manager-applet|Provides nm-connection-editor (advanced network settings)|true"
    "blueman|Provides blueman-manager (advanced Bluetooth settings)|true"
